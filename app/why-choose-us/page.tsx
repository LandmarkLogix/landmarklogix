...
export const metadata: Metadata = {
  title: "Why Choose Landmark Logix - Owner's Representation and Project Management",
  description:
    "Discover why Landmark Logix is the trusted partner for landmark construction projects. Uncompromising quality, heritage preservation expertise, community focus, and proven excellence across the East Coast.",
  keywords:
    "landmark construction, heritage preservation, project management, owner's representation, quality construction, community buildings",
}
...
export default function WhyChooseUsPage() {
  return (
    <main className="min-h-screen">
      <ErrorBoundary>
        <section className="py-16 sm:py-20 bg-white" aria-labelledby="why-choose-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto text-pretty">
                When your building will serve the community for generations, you need a partner who understands the
